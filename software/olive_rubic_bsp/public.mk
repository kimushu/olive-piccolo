...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../olive_std_core.sopcinfo
...
# setting BSP_SYS_LIB is tinyth_bsp
BSP_SYS_LIB := tinyth_bsp
ELF_PATCH_FLAG  += --thread_model tinyth

# Type identifier of the BSP library 
# setting BSP_TYPE is tinyth
...
# Design Name 
# setting SOPC_NAME is olive_std_core
SOPC_NAME := olive_std_core
...
# The SOPC System ID 
# setting SOPC_SYSID is 1923109377
SOPC_SYSID_FLAG += --id=1923109377
ELF_PATCH_FLAG  += --id 1923109377
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1507600124
SOPC_SYSID_FLAG += --timestamp=1507600124
ELF_PATCH_FLAG  += --timestamp 1507600124
...
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/TINYTH/inc
