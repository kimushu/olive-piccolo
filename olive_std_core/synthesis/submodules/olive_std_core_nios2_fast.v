...
`timescale 1 ps / 1 ps
module olive_std_core_nios2_fast (
		...
		input  wire        cpu_resetrequest,                    //  cpu_resetrequest_conduit.cpu_resetrequest
		output wire        cpu_resettaken                       //                          .cpu_resettaken
	);

	olive_std_core_nios2_fast_cpu cpu (
		.clk                                 (clk),                                 //                       clk.clk
		...
		.cpu_resetrequest                    (cpu_resetrequest),                    //  cpu_resetrequest_conduit.cpu_resetrequest
		.cpu_resettaken                      (cpu_resettaken)                       //                          .cpu_resettaken
	);
